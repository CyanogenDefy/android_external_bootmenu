...
LOCAL_CFLAGS += -DBOOTMENU_VERSION="${BOOTMENU_VERSION}${BOOTMENU_SUFFIX}" -DENABLE_MENU_SYSTEM=0
...
LOCAL_CFLAGS := -DBOOTMENU_VERSION="${BOOTMENU_VERSION}${BOOTMENU_SUFFIX}" -DENABLE_MENU_SYSTEM=1
...
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/system/bootmenu/binary/bootmenu
